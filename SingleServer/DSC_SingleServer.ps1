...
#>
        ...
        Script MinecraftRunning {
            ...
            SetScript = { Start-Process -FilePath "C:\Program Files\Java\jre1.8.0_111\bin\java.exe" -ArgumentList "-Xmx1024M -Xms1024M -jar C:\Minecraft\minecraft_server.jar nogui" -WorkingDirectory C:\Minecraft }
